...
AUTOMATION_GATEWAY_DIR = BASE_DIR / "automation_gateway"
AUTOMATION_GATEWAY_CONFIGS_DIR = AUTOMATION_GATEWAY_DIR / "configs"
AUTOMATION_GATEWAY_TEMPLATES_DIR = AUTOMATION_GATEWAY_DIR / "templates"
